...
const informedConsentText = [
    ...
    '<p><b>1.本実験・調査の目的</b>' +
    '<br>技術・趣味・地方の三つの分野にまたがる質問をすることで、<br>各分野での学生の傾向を知るとともに、それぞれの質問間での相関などを調べる。</p>' +
    '<p><b>2.本実験・調査の手続き</b>' +
    '<br>各ページの設問に対し、入力したり、選択したりしてください。' +
    '<br>この実験・調査に所要時間はXXXXXXXXXです。</p>' +
    '<p><b>5.匿名性の確保</b>' +
    '<br>質問に答えていただいた内容は、個人が特定できないようなかたちでのみ使用されます。</p>' +
    '<p><b>6.参加と中止</b>' +
    '<br>質問に答えていただいている間、いつでも中断していただいて構いません</p>' +
    '<p><b>7.実験・調査実施者への問い合わせ</b>' +
    '<br>oooo@ed.fuk.kindai.ac.jp</p></div>'
];
...
const askAboutHomeTown = {
    preamble: '<p style = "font-size: 2vh">続いて、以下の出身地に関する質問にご回答ください</p>',
    type: 'survey-likert',
    questions: [{
        prompt: '私の出身地は都会だと思う',
...
const askAboutDenomination = {
    preamble: '<p style = "font-size: 2vh"><b>続いて、以下の宗派に関する質問にご回答ください</b>' +
    '<br>これが最後の質問ページです。「次へ」を押すと白真っ白な画面になり実験は終了になります' +
    '<br>ご協力ありがとうございました。</p>',
    type: 'survey-likert',
    questions: [{
...
// const hello_trial = {
//     type: 'html-keyboard-response',
//     stimulus: '質問は以上になります。ご協力ありがとうございました。'
// };
